...
.modal {
  ...
  &__footer {
    /deep/ {
      background-color: darken($color-shark-dark, 4);
    ...
    &--transparent {
      ...
      flex: 0 0 auto;
      padding: 1rem;
      background-color: rgba($color-shark-dark, 0) !important;
  ...
  &Top {
    ...
    .modal__footer {
      background: darken($color-shark-dark, 4);
    }
  }
}
</style>
